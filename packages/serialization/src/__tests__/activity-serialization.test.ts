...
describe('Activity Serialization', () => {
  ...
  it('should handle round-trip encoding with multiple elements', () => {
    ...
    const activity: Activity = {
      ...
      serviceStats: new Map([
        [1n, { provision: 100, refinement: 50, accumulation: 25, transfer: 10, importCount: 5, extrinsicCount: 3, extrinsicSize: 512, exportCount: 2 }],
        [2n, { provision: 200, refinement: 100, accumulation: 50, transfer: 20, importCount: 10, extrinsicCount: 6, extrinsicSize: 1024, exportCount: 4 }],
      ]),
    }
