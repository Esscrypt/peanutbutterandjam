 ...
 */
export function encodeOperandTuple(operandTuple: OperandTuple): OctetSequence {
  ...
  if (typeof operandTuple.result === 'string') {
    // Error result
    const errorBytes = new TextEncoder().encode(operandTuple.result)
 ...
 */
export function decodeOperandTuple(data: OctetSequence): {
  value: OperandTuple
