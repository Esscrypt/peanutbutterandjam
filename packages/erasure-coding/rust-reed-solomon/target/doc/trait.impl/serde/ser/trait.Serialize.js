;(() => {
  var implementors = Object.fromEntries([
    ...
    [
      ...
      [
        [
          'impl <a class="trait" href="serde/ser/trait.Serialize.html" title="trait serde::ser::Serialize">Serialize</a> for <a class="enum" href="serde_json/enum.Value.html" title="enum serde_json::Value">Value</a>',
        ],
        [
        ...
        [
          'impl <a class="trait" href="serde/ser/trait.Serialize.html" title="trait serde::ser::Serialize">Serialize</a> for <a class="struct" href="serde_json/struct.Number.html" title="struct serde_json::Number">Number</a>',
        ],
      ],
    ],
  ])
...
//{"start":57,"fragment_lengths":[12,939]}
