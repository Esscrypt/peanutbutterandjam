  ...
  const adaptedExports = Object.setPrototypeOf(
    {
      RAMType: ((values) =>
        (
          ...
          (values[(values.PVMRAM = exports['RAMType.PVMRAM'].valueOf())] =
            'PVMRAM'),
          (values[(values.SimpleRAM = exports['RAMType.SimpleRAM'].valueOf())] =
            'SimpleRAM'),
          (values[(values.MockRAM = exports['RAMType.MockRAM'].valueOf())] =
            'MockRAM'),
          values
        ))({}),
      resetGeneric(program, registers, gas) {
        ...
        program = __retain(
          __lowerTypedArray(Uint8Array, 15, 0, program) || __notnull(),
        )
        registers =
          __lowerTypedArray(Uint8Array, 15, 0, registers) || __notnull()
        try {
      ...
      resetGenericWithMemory(
        ...
        programPtr = __retain(
          __lowerTypedArray(Uint8Array, 15, 0, programPtr) || __notnull(),
        )
        registersPtr = __retain(
          __lowerTypedArray(Uint8Array, 15, 0, registersPtr) || __notnull(),
        )
        pageMapPtr = __retain(
          __lowerTypedArray(Uint8Array, 15, 0, pageMapPtr) || __notnull(),
        )
        chunksPtr =
          __lowerTypedArray(Uint8Array, 15, 0, chunksPtr) || __notnull()
        try {
          exports.resetGenericWithMemory(
            programPtr,
            registersPtr,
            pageMapPtr,
            chunksPtr,
      ...
      accumulateInvocation(
        ...
        args = __retain(
          __lowerTypedArray(Uint8Array, 15, 0, args) || __notnull(),
        )
        context = __retain(
          __lowerTypedArray(Uint8Array, 15, 0, context) || __notnull(),
        )
        entropyAccumulator = __retain(
          __lowerTypedArray(Uint8Array, 15, 0, entropyAccumulator) ||
            __notnull(),
        )
        encodedWorkItems =
          __lowerTypedArray(Uint8Array, 15, 0, encodedWorkItems) || __notnull()
        configMaxBlockGas = configMaxBlockGas || 0n
        try {
          exports.__setArgumentsLength(arguments.length)
          return __liftInternref(
            exports.accumulateInvocation(
              gasLimit,
              program,
              args,
              context,
      ...
      setupAccumulateInvocation(
        ...
        try {
          exports.__setArgumentsLength(arguments.length)
          exports.setupAccumulateInvocation(
            gasLimit,
            program,
            args,
            context,
      ...
      setAccumulateInputs(inputs) {
        ...
        inputs = __lowerArray(
          (pointer, value) => {
            __setU32(pointer, __lowerInternref(value) || __notnull())
          },
          51,
          2,
          inputs,
      ...
      getAccumulationContext(numCores, numValidators, authQueueSize) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.getAccumulationContext(
            numCores,
            numValidators,
            authQueueSize,
          ) >>> 0,
      ...
      decodeBlob(programBlob) {
        ...
        programBlob =
          __lowerTypedArray(Uint8Array, 15, 0, programBlob) || __notnull()
      ...
      decodeServiceCodeFromPreimage(preimageBlob) {
        ...
        preimageBlob =
          __lowerTypedArray(Uint8Array, 15, 0, preimageBlob) || __notnull()
        return __liftInternref(
          exports.decodeServiceCodeFromPreimage(preimageBlob) >>> 0,
        )
      },
      ...
      decodeProgramFromPreimage(preimageBlob) {
        ...
        preimageBlob =
          __lowerTypedArray(Uint8Array, 15, 0, preimageBlob) || __notnull()
        return __liftInternref(
          exports.decodeProgramFromPreimage(preimageBlob) >>> 0,
        )
      },
      encodeServiceAccount(account, major, minor, patch) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeServiceAccount(account, major, minor, patch) >>> 0,
        )
      },
      decodeServiceAccount(data, major, minor, patch) {
        ...
        exports.__setArgumentsLength(arguments.length)
        return __liftInternref(
          exports.decodeServiceAccount(data, major, minor, patch) >>> 0,
        )
      },
      encodeFixedLength(value, length) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeFixedLength(value, length) >>> 0,
        )
      },
      encodeNatural(value) {
      ...
      encodeRefineContext(context) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeRefineContext(context) >>> 0,
        )
      },
      encodeImportReference(importRef) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeImportReference(importRef) >>> 0,
        )
      },
      encodeExtrinsicReference(extrinsicRef) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeExtrinsicReference(extrinsicRef) >>> 0,
        )
      },
      encodeVariableSequence(sequence) {
        ...
        sequence =
          __lowerArray(
            (pointer, value) => {
              __setU32(
                pointer,
                __lowerTypedArray(Uint8Array, 15, 0, value) || __notnull(),
              )
            },
            41,
            2,
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeVariableSequence(sequence) >>> 0,
        )
      },
      encodeWorkItem(workItem) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeWorkItem(workItem) >>> 0,
        )
      },
      encodeWorkItemSummary(workItem) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeWorkItemSummary(workItem) >>> 0,
        )
      },
      ...
      encodeWorkPackage(workPackage) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeWorkPackage(workPackage) >>> 0,
        )
      },
      ...
      decodeVariableSequence(data, elementDecoder) {
        ...
        data = __retain(
          __lowerTypedArray(Uint8Array, 15, 0, data) || __notnull(),
        )
        elementDecoder = __lowerInternref(elementDecoder) || __notnull()
        try {
          return __liftInternref(
            exports.decodeVariableSequence(data, elementDecoder) >>> 0,
          )
        } finally {
          __release(data)
        }
      ...
      decodeImplicationsPair(data, numCores, numValidators, authQueueSize) {
        ...
        data = __lowerTypedArray(Uint8Array, 15, 0, data) || __notnull()
        return __liftInternref(
          exports.decodeImplicationsPair(
            data,
            numCores,
            numValidators,
            authQueueSize,
      ...
      encodeOptional(value, encoder) {
        ...
        try {
          return __liftTypedArray(
            Uint8Array,
            exports.encodeOptional(value, encoder) >>> 0,
          )
        } finally {
          __release(value)
        }
      ...
      encodeDeferredTransfer(transfer) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeDeferredTransfer(transfer) >>> 0,
        )
      },
      encodeWorkResult(resultType, result) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeWorkResult(resultType, result) >>> 0,
        )
      },
      encodeOperandTuple(ot) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeOperandTuple(ot) >>> 0,
        )
      },
      encodeAccumulateInput(input) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeAccumulateInput(input) >>> 0,
        )
      },
      ...
      encodeVariableSequenceGeneric(sequence, elementEncoder) {
        ...
        sequence = __retain(
          __lowerArray(__setU32, 14, 2, sequence) || __notnull(),
        )
        elementEncoder = __lowerInternref(elementEncoder) || __notnull()
        try {
          return __liftTypedArray(
            Uint8Array,
            exports.encodeVariableSequenceGeneric(sequence, elementEncoder) >>>
              0,
          )
        } finally {
          __release(sequence)
      ...
      encodeCompleteServiceAccount(account) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeCompleteServiceAccount(account) >>> 0,
        )
      },
      ...
      encodeImplicationsPair(pair, numCores, numValidators, authQueueSize) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.encodeImplicationsPair(
            pair,
            numCores,
            numValidators,
            authQueueSize,
      ...
      MemoryAccessType: ((values) =>
        (
          ...
          (values[(values.NONE = exports['MemoryAccessType.NONE'].valueOf())] =
            'NONE'),
          (values[(values.READ = exports['MemoryAccessType.READ'].valueOf())] =
            'READ'),
          (values[
            (values.WRITE = exports['MemoryAccessType.WRITE'].valueOf())
          ] = 'WRITE'),
          values
        ))({}),
      bytesToHex(bytes) {
      ...
      Status: ((values) =>
        (
          ...
          (values[(values.PANIC = exports['Status.PANIC'].valueOf())] =
            'PANIC'),
          (values[(values.FAULT = exports['Status.FAULT'].valueOf())] =
            'FAULT'),
      ...
      roundTripSingleImplications(
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.roundTripSingleImplications(
            data,
            numCores,
            numValidators,
            authQueueSize,
      ...
      roundTripServiceAccount(data) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.roundTripServiceAccount(data) >>> 0,
        )
      },
      ...
      getDecodedProgramFields(preimageBlob) {
        ...
        preimageBlob =
          __lowerTypedArray(Uint8Array, 15, 0, preimageBlob) || __notnull()
        return __liftInternref(
          exports.getDecodedProgramFields(preimageBlob) >>> 0,
        )
      },
      roundTripAccumulateInputs(data) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.roundTripAccumulateInputs(data) >>> 0,
        )
      },
      roundTripSingleAccumulateInput(data) {
        ...
        return __liftTypedArray(
          Uint8Array,
          exports.roundTripSingleAccumulateInput(data) >>> 0,
        )
      },
    },
    exports,
