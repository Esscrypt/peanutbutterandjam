...
export declare function setAccumulateInputs(
  inputs: Array<__Internref42> | null,
): void
/**
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function createStorageKey(
  serviceId: number,
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function createPreimageKey(
  serviceId: number,
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function createRequestKey(
  serviceId: number,
 ...
 */
export declare function getStorageValue(
 ...
 * @returns `bool`
 */
export declare function deleteStorageValue(
  account: __Internref29,
  serviceId: number,
  storageKey: Uint8Array,
): boolean
 ...
 * @returns `~lib/typedarray/Uint8Array | null`
 */
export declare function getPreimageValue(
  account: __Internref29,
  serviceId: number,
  preimageHash: Uint8Array,
): Uint8Array | null
 ...
 */
export declare function setPreimageValue(
  account: __Internref29,
  serviceId: number,
  preimageHash: Uint8Array,
  blob: Uint8Array,
 ...
 * @returns `bool`
 */
export declare function deletePreimageValue(
  account: __Internref29,
  serviceId: number,
  preimageHash: Uint8Array,
): boolean
 ...
 * @returns `~lib/typedarray/Uint8Array | null`
 */
export declare function getRequestValue(
  account: __Internref29,
  serviceId: number,
  requestHash: Uint8Array,
  length: bigint,
 ...
 * @param value `~lib/typedarray/Uint8Array`
 */
export declare function setRequestValue(
  account: __Internref29,
  serviceId: number,
  requestHash: Uint8Array,
  length: bigint,
 ...
 * @returns `bool`
 */
export declare function deleteRequestValue(
  account: __Internref29,
  serviceId: number,
  requestHash: Uint8Array,
  length: bigint,
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function encodeRequestTimeslots(
 ...
 */
export declare function decodeRequestTimeslots(
  value: Uint8Array,
): Array<number> | null
/**
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function encodeAccumulateInput(
  input: __Internref42,
  jamVersionMajor?: number,
  jamVersionMinor?: number,
  jamVersionPatch?: number,
 ...
 */
export declare function encodeVariableSequenceGeneric(
  sequence: Array<__Internref38>,
  elementEncoder: __Internref276,
): Uint8Array
/**
 ...
 */
export declare function encodeVariableSequenceGeneric(
  sequence: Array<__Internref40>,
  elementEncoder: __Internref279,
): Uint8Array
/**
 ...
 */
export declare function encodeVariableSequenceGeneric(
  sequence: Array<__Internref42>,
  elementEncoder: __Internref287,
): Uint8Array
/**
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function createServiceStorageKey(
  serviceId: bigint,
  storageKey: Uint8Array,
): Uint8Array
/**
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function createServicePreimageKey(
  serviceId: bigint,
  preimageHash: Uint8Array,
): Uint8Array
/**
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function createServiceRequestKey(
  serviceId: bigint,
  requestHash: Uint8Array,
  length: bigint,
): Uint8Array
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function testCreateStorageKey(
  serviceId: number,
  storageKey: Uint8Array,
): Uint8Array
/**
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function testCreatePreimageKey(
  serviceId: number,
  preimageHash: Uint8Array,
): Uint8Array
/**
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function testCreateRequestKey(
  serviceId: number,
  requestHash: Uint8Array,
  length: bigint,
): Uint8Array
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function testEncodeFixedLength(
  value: bigint,
  length: number,
): Uint8Array
/**
 ...
 * @returns `u64`
 */
export declare function testCalculateMinBalance(
  items: bigint,
  octets: bigint,
  gratis: bigint,
): bigint
 ...
 */
export declare function testSolicitLogic(
 ...
 * @returns `assembly/test-exports/HostFunctionTestResult`
 */
export declare function testForgetLogic(
  encodedAccount: Uint8Array,
  serviceId: number,
  requestHash: Uint8Array,
  preimageLength: bigint,
 ...
 * @returns `assembly/test-exports/HostFunctionTestResult`
 */
export declare function testQueryLogic(
  encodedAccount: Uint8Array,
  serviceId: number,
  requestHash: Uint8Array,
  preimageLength: bigint,
 ...
 * @returns `assembly/test-exports/HostFunctionTestResult`
 */
export declare function testWriteLogic(
  encodedAccount: Uint8Array,
  serviceId: number,
  key: Uint8Array,
  value: Uint8Array,
 ...
 * @returns `assembly/test-exports/HostFunctionTestResult`
 */
export declare function testReadLogic(
  encodedAccount: Uint8Array,
  serviceId: number,
  key: Uint8Array,
  fromOffset: number,
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function testEncodeRequestTimeslots(
  timeslots: Array<number>,
): Uint8Array
/**
 ...
 * @returns `~lib/array/Array<u32> | null`
 */
export declare function testDecodeRequestTimeslots(
  data: Uint8Array,
): Array<number> | null
/**
 ...
 */
export declare function testSbrkLogic(
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function testGetSystemConstants(
  numCores: number,
 ...
 * @returns `i32`
 */
export declare function debugDecodeAndCheckStorage(
  data: Uint8Array,
  numCores: number,
  numValidators: number,
  authQueueSize: number,
 ...
 * @returns `i32`
 */
export declare function debugStorageLookup(
  data: Uint8Array,
  numCores: number,
  numValidators: number,
  authQueueSize: number,
 ...
 * @returns `~lib/typedarray/Uint8Array`
 */
export declare function debugGetFirstStorageKey(
  data: Uint8Array,
  numCores: number,
  numValidators: number,
  authQueueSize: number,
