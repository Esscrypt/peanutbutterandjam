...
describe('JAM Conformance Single Trace', () => {
  ...
  it(`should process trace ${traceId}`, async () => {
    ...
    const services = await initializeServices({ spec: 'tiny', traceSubfolder, genesisManager, initialValidators, useWasm: true, useRingVrfWasm: true, useIetfVrfWasm: true })
